...
class Subscription extends Model
{
     ...
     * @return $this
     */
    public function cancel(array $stripeOptions = [])
    {
        $stripeSubscription = $this->updateStripeSubscription([
     ...
     */
    public function updateStripeSubscription(array $options = [], array $stripeOptions = [])
    {
        return $this->owner->stripe($stripeOptions)->subscriptions->update(
